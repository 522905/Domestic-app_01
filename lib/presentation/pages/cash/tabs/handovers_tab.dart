...
class HandoversTab extends StatelessWidget {
              ...
              return Column(
                ...
                children: [
                  ...
                  ...dateTransactions.map((tx) => TransactionItem(
                    transaction: tx,
                    onTap: () => _showHandoverDetails(context, tx),
                  )).toList(),
                ],
              );
            },
  ...
  void _showHandoverDetails(BuildContext context, CashTransaction transaction) {
    if (transaction.status == TransactionStatus.pending) {
      // Navigate directly to approval screen for pending transactions
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => HandoverApprovalScreen(
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow('Handover ID', transaction.id),
              ...
              if (transaction.selectedAccount != null)
                _buildDetailRow('Recipient', transaction.selectedAccount!),

              if (transaction.selectedBank != null)
              ...
              // Show receipt if available (mock for now)
              if (transaction.status != TransactionStatus.pending) ...[
                Text(
                  'Receipt',
                  style: TextStyle(
                ...
                SizedBox(height: 8.h),
                Center(
                  child: transaction.receiptImagePath != null
                      ? InkWell(
